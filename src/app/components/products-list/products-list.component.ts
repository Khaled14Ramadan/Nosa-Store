...
export class ProductsListComponent implements OnInit {
  ...
  products : Product[] = [
    {
      ...
      "name":"Wadi Food Natural Green ",
      "image":"https://via.placeholder.com/150/000000/0000000/?text=IPaddress.net",
      rate: 0,
      count: 0,
      description: "",
      price: "1232",
  ...
  ngOnInit(): void {
   // receive the products from API by HTTPservice
   this.httpService.getProducts().subscribe((respond:any)=>{
      // console.log(respond);
      this.check =false;
